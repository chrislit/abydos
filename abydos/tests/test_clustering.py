...
anssetw = ('a acucar cair cha de do e feliz ima jabuti kowalsky no noite o pe pinguim poe queixoso tamarasve vovo',)
...
class fingerprint_test_cases(unittest.TestCase):
    def test_fingerprint(self):
        ...
        for i in len(testset):
            self.assertEquals(fingerprint(testset[i]), anssetw)
