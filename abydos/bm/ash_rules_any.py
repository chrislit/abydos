...
"""
             ...
             #CONSONANTS(integrated:German,Polish,Russian,RomanianandEnglish)
             ...
             ('ssz','','','S'),#Polish
             ('sz','','','S'),#Polish;actuallycouldalsobeHungarian/s/,disabledhere
             ...
             ('h','^','','(h|H['.($english+$german).'])'),#Hcanbeexact'h'orapproximate'kh'
             
             #VOWELS
             ('yi','^','','i'),
             
             #('e','','$','(e|)'),#French&Englishruledisabledexceptforfinal-ine
             ('e','in','$','(e|[$french])'),
