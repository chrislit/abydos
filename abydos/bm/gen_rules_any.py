             ...
             ('lio','','','(lo|le[$russian])'),
             ('lyo','','','(lo|le[$russian])'),
             #('ll','','','(l|J[$spanish])'),#DisabledArgentinianrule
             ('lt','u','$','(lt|[$french])'),
             ...
             #Proceccingof'h'invariouscombinations
             ('rh','^','','r'),
             ('dh','^','','d'),
             ('bh','^','','b'),
             ...
             ('ggie','','','(je[$greeklatin]|dZe)'),#dZisItalian
             ('ggi','','[aou]','(j[$greeklatin]|dZ)'),#dZisItalian
             ...
             ('gi','','[aou]','(i[$greeklatin]|dZ)'),#dZisItalian
             ...
             ('z','','$','(s|ts[$german]|ts[$italian]|S[$portuguese])'),#tsIt,s/S/ZPort,sinSp,zFr
             ...
             ('e','','','E'),
             ('f','','','f'),
             #('g','','','(g|x[$dutch])'),#Dutchsounddisabled
             ('g','','','g'),
             ...
             ('y','','','i'),
             ('z','','','(z|ts[$german]|dz[$italian]|ts[$italian]|s[$spanish])'),#ts/dzIt,zPort&Fr,z/sSp
