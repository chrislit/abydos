...
"""abydos.fingerprint._phonetic_fingerprint.
...
from ._string_fingerprint import StringFingerprint
from ..phonetic import double_metaphone

__all__ = ['PhoneticFingerprint', 'phonetic_fingerprint']


class PhoneticFingerprint(StringFingerprint):
    """Phonetic Fingerprint.
