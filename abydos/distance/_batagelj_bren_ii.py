...
"""abydos.distance._batagelj_bren_ii.

Batagelj & Bren II similarity
"""
...
__all__ = ['BatageljBrenII']


class BatageljBrenII(_TokenDistance):
    r"""Batagelj & Bren II similarity.

    For two sets X and Y and a population N, the Batagelj & Bren II
    similarity :cite:`Batagelj:1995`, Batagelj & Bren's :math:`- bc -`, is

        .. math::

            sim_{BatageljBrenII}(X, Y) =
    ...
    def __init__(
        ...
        **kwargs
        ...
        """Initialize BatageljBrenII instance.
        ...
        **kwargs
        ...
        """
        super(BatageljBrenII, self).__init__(
            alphabet=alphabet,
            tokenizer=tokenizer,
    ...
    def sim(self, src, tar):
        """Return the Batagelj & Bren II similarity of two strings.
