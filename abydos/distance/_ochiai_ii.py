...
"""abydos.distance._ochiai_ii.

Ochiai II similarity
"""
...
class OchiaiII(_TokenDistance):
    r"""Ochiai II similarity.
    ...
    def sim(self, src, tar):
        """Return the Ochiai II similarity of two strings.
