...
"""abydos.distance._yule_sigma.

Yule's Sigma similarity
"""
...
class YuleSigma(_TokenDistance):
    r"""Yule's Sigma similarity.
    ...
    def sim(self, src, tar):
        """Return the Yule's Sigma similarity of two strings.
