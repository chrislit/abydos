...
class PositionalQGramJaccard(_Distance):
    r"""Positional Q-Gram Jaccard distance.

    Positional Q-Gram Jaccard distance :cite:`CITATION`
    ...
    def __init__(self, **kwargs):
        ...
        **kwargs
        ...
        """
        super(PositionalQGramJaccard, self).__init__(**kwargs)

    def dist(self, src, tar):
        """Return the Positional Q-Gram Jaccard distance of two strings.
