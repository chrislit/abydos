...
"""abydos.distance._baulieu_shape_difference.

Baulieu's Shape Difference distance
"""
...
__all__ = ['BaulieuShapeDifference']


class BaulieuShapeDifference(_TokenDistance):
    r"""Baulieu's Shape Difference distance.
    ...
    def __init__(
        ...
        **kwargs
        ...
        """Initialize BaulieuShapeDifference instance.
        ...
        **kwargs
        ...
        """
        super(BaulieuShapeDifference, self).__init__(
            alphabet=alphabet,
            tokenizer=tokenizer,
    ...
    def sim(self, src, tar):
        """Return the Baulieu's Shape Difference distance of two strings.
