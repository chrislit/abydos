...
"""abydos.distance._squared_euclid.
...
__all__ = ['SquaredEuclid']


class SquaredEuclid(_TokenDistance):
    r"""Squared Euclid distance.
    ...
    def __init__(
        ...
        **kwargs
        ...
        """Initialize SquaredEuclid instance.
        ...
        **kwargs
        ...
        """
        super(SquaredEuclid, self).__init__(
            alphabet=alphabet,
            tokenizer=tokenizer,
    ...
    def sim(self, src, tar):
        """Return the Squared Euclid distance of two strings.
