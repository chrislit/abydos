...
"""abydos.distance._kuhns'_proportion.
...
__all__ = ['Kuhns'Proportion']


class Kuhns'Proportion(_TokenDistance):
    ...
    def __init__(
        ...
        **kwargs
        ...
        """Initialize Kuhns'Proportion instance.
        ...
        **kwargs
        ...
        """
        super(Kuhns'Proportion, self).__init__(
            alphabet=alphabet,
            tokenizer=tokenizer,
