...
class Tetrachoric(_TokenDistance):
    r"""Tetrachoric correlation coefficient.
    ...
    def sim(self, src, tar):
        ...
        rad = (self.intersection_card() * self.total_complement_card()) ** 0.5
        rbc = (self.src_only_card() * self.tar_only_card()) ** 0.5
