...
class Czekanowski(_TokenDistance):
    r"""Czekanowski similarity.
    ...
    def __init__(
        ...
        **kwargs
        ...
        """Initialize Czekanowski instance.
        ...
        **kwargs
        ...
        """
        super(Czekanowski, self).__init__(
            alphabet=alphabet,
            tokenizer=tokenizer,
    ...
    def sim(self, src, tar):
        """Return the Czekanowski similarity of two strings.
