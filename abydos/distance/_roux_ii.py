...
class RouxII(_TokenDistance):
    r"""Roux II similarity.

    For two sets X and Y and a population N, Roux II similarity
    :cite:`CITATION` is
    ...
    def sim(self, src, tar):
        """Return the Roux II similarity of two strings.
