...
"""abydos.distance._phi_squared.

Phi Squared similarity
"""
...
class PhiSquared(_TokenDistance):
    r"""Phi Squared similarity.
    ...
    def __init__(
        ...
        **kwargs
        ...
        """Initialize PhiSquared instance.
        ...
        **kwargs
        ...
        """
        super(PhiSquared, self).__init__(
            alphabet=alphabet,
            tokenizer=tokenizer,
    ...
    def sim(self, src, tar):
        """Return the Phi Squared similarity of two strings.
