...
"""abydos.distance._kocher_wong.

Kocher & Wong similarity
"""
...
class KocherWong(_TokenDistance):
    ...
    def __init__(
        ...
        **kwargs
        ...
        """Initialize KocherWong instance.
        ...
        **kwargs
        ...
        """
        super(KocherWong, self).__init__(
            alphabet=alphabet,
            tokenizer=tokenizer,
    ...
    def sim(self, src, tar):
        """Return the Kocher & Wong similarity of two strings.
