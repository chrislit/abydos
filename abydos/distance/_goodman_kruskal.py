...
"""abydos.distance._goodman_kruskal.
...
__all__ = ['GoodmanKruskal']


class GoodmanKruskal(_TokenDistance):
    r"""Goodman & Kruskal similarity.
    ...
    def __init__(
        ...
        **kwargs
        ...
        """Initialize GoodmanKruskal instance.
        ...
        **kwargs
        ...
        """
        super(GoodmanKruskal, self).__init__(
            alphabet=alphabet,
            tokenizer=tokenizer,
    ...
    def sim(self, src, tar):
        """Return the Goodman & Kruskal similarity of two strings.
