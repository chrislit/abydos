...
class SpanishMetaphoneTestCases(unittest.TestCase):
    ...
    def test_spanish_metaphone(self):
        ...
        self.assertEqual(self.pa.encode('Caricia'), 'KRZ')
        self.assertEqual(self.pa.encode('Caricia', modified=True), 'KRZ')
        self.assertEqual(self.pa.encode('Llaves'), 'YVS')
        self.assertEqual(self.pa.encode('Llaves', modified=True), 'YVZ')
        self.assertEqual(self.pa.encode('Paella'), 'PY')
        self.assertEqual(self.pa.encode('Paella', modified=True), 'PY')
        self.assertEqual(self.pa.encode('Cerilla'), 'ZRY')
        self.assertEqual(self.pa.encode('Cerilla', modified=True), 'ZRY')
        self.assertEqual(self.pa.encode('Empeorar'), 'EMPRR')
        self.assertEqual(self.pa.encode('Empeorar', modified=True), 'ENPRR')
        self.assertEqual(self.pa.encode('Embotellar'), 'EMVTYR')
        self.assertEqual(self.pa.encode('Embotellar', modified=True), 'ENVTYR')
        self.assertEqual(self.pa.encode('Hoy'), 'OY')
        self.assertEqual(self.pa.encode('Hoy', modified=True), 'OY')
        self.assertEqual(self.pa.encode('Xochimilco'), 'XXMLK')
        self.assertEqual(self.pa.encode('Xochimilco', modified=True), 'XXMLK')
        self.assertEqual(self.pa.encode('Psiquiatra'), 'PSKTR')
        self.assertEqual(self.pa.encode('Psiquiatra', modified=True), 'ZKTR')
        self.assertEqual(self.pa.encode('siquiatra'), 'SKTR')
        self.assertEqual(self.pa.encode('siquiatra', modified=True), 'ZKTR')
        self.assertEqual(self.pa.encode('Obscuro'), 'OVSKR')
        self.assertEqual(self.pa.encode('Obscuro', modified=True), 'OZKR')
        self.assertEqual(self.pa.encode('Oscuro'), 'OSKR')
        self.assertEqual(self.pa.encode('Oscuro', modified=True), 'OZKR')
        self.assertEqual(self.pa.encode('Combate'), 'KMVT')
        self.assertEqual(self.pa.encode('Combate', modified=True), 'KNVT')
        self.assertEqual(self.pa.encode('Convate'), 'KNVT')
        self.assertEqual(self.pa.encode('Convate', modified=True), 'KNVT')
        self.assertEqual(self.pa.encode('Conbate'), 'KNVT')
        self.assertEqual(self.pa.encode('Conbate', modified=True), 'KNVT')
        self.assertEqual(self.pa.encode('Comportar'), 'KMPRTR')
        self.assertEqual(self.pa.encode('Comportar', modified=True), 'KNPRTR')
        self.assertEqual(self.pa.encode('Conportar'), 'KNPRTR')
        self.assertEqual(self.pa.encode('Conportar', modified=True), 'KNPRTR')
        self.assertEqual(self.pa.encode('Zapato'), 'ZPT')
        self.assertEqual(self.pa.encode('Zapato', modified=True), 'ZPT')
        self.assertEqual(self.pa.encode('Sapato'), 'SPT')
        self.assertEqual(self.pa.encode('Sapato', modified=True), 'ZPT')
        self.assertEqual(self.pa.encode('Escalera'), 'ESKLR')
        self.assertEqual(self.pa.encode('Escalera', modified=True), 'EZKLR')
        self.assertEqual(self.pa.encode('scalera'), 'ESKLR')
        self.assertEqual(self.pa.encode('scalera', modified=True), 'EZKLR')
