...
class SfinxBisTestCases(unittest.TestCase):
    ...
    def test_sfinxbis(self):
        ...
        self.assertEqual(self.pa.encode('Hård af Segerstad'), 'H63,S26833')
        self.assertEqual(self.pa.encode('Hård av Segerstad'), 'H63,S26833')
        self.assertEqual(self.pa.encode('Stael von Holstein'), 'S34,H48325')
        self.assertEqual(self.pa.encode('de Oliveira e Silva'), '$4726,S47')
        self.assertEqual(self.pa.encode('de Alfaro y Gómez'), '$476,G58')
        self.assertEqual(self.pa.encode('Arjaliès-de la Lande'), '$6248,L53')
        self.assertEqual(
        ...
        self.assertEqual(self.pa.encode('Jonsson-Blomqvist'), 'J585,B452783')
        self.assertEqual(self.pa.encode('Kiviniemi Birgersson'), '#755,B62685')
        self.assertEqual(
            self.pa.encode('Massena Serpa dos Santos'), 'M85,S61,S538'
        )
        self.assertEqual(self.pa.encode('S:t Clair Renard'), 'K426,R563')
        self.assertEqual(self.pa.encode('Skoog H Andersson'), 'S22,H,$53685')
        self.assertEqual(self.pa.encode('von Post-Skagegård'), 'P83,S22263')
        ...
        self.assertEqual(SfinxBis(3).encode('Kiviniemi Birgersson'), '#75,B62')
        ...
        self.assertEqual(self.pa.encode_alpha('de Alfaro y Gómez'), '$LFR,GNS')
        self.assertEqual(
