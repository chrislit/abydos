...
class UnknownHTestCases(unittest.TestCase):
    ...
    def test_unknown_h_dist(self):
        ...
        self.assertEqual(self.cmp.dist('', 'abc'), float('nan'))
        self.assertEqual(self.cmp.dist('abc', 'abc'), -26.857142857142858)
        ...
        self.assertEqual(self.cmp_no_d.dist('abcd', 'efgh'), 2.58113883008419)
        ...
        self.assertAlmostEqual(
            self.cmp_no_d.dist('ATCAACGAGT', 'AACGATTAG'), 1.3057883149
        )
