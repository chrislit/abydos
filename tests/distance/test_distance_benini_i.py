...
class BeniniITestCases(unittest.TestCase):
    """Test BeniniI functions.

    abydos.distance.BeniniI
    """
    ...
    def test_benini_i_sim(self):
        ...
        self.assertAlmostEqual(
            self.cmp_no_d.sim('ATCAACGAGT', 'AACGATTAG'), -0.4
        )
    ...
    def test_benini_i_dist(self):
        ...
        self.assertAlmostEqual(
            self.cmp_no_d.dist('ATCAACGAGT', 'AACGATTAG'), 1.4
        )
