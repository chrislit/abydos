...
class KuhnsVIIITestCases(unittest.TestCase):
    ...
    def test_kuhns_viii_sim(self):
        ...
        self.assertAlmostEqual(
            self.cmp.sim('ATCAACGAGT', 'AACGATTAG'), 0.6533041788
        )
        ...
        self.assertAlmostEqual(
            self.cmp_no_d.sim('ATCAACGAGT', 'AACGATTAG'), -0.0816326531
        )
    ...
    def test_kuhns_viii_dist(self):
        ...
        self.assertAlmostEqual(
            self.cmp.dist('ATCAACGAGT', 'AACGATTAG'), 0.3466958212
        )
        ...
        self.assertAlmostEqual(
            self.cmp_no_d.dist('ATCAACGAGT', 'AACGATTAG'), 1.0816326531
        )
