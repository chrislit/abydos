...
class KuhnsVIIITestCases(unittest.TestCase):
    ...
    def test_kuhns_viii_sim(self):
        ...
        self.assertAlmostEqual(
            self.cmp.sim('ATCAACGAGT', 'AACGATTAG'), 0.7688694525
        )
        ...
        self.assertAlmostEqual(
            self.cmp_no_d.sim('ATCAACGAGT', 'AACGATTAG'), 0.2789115646
        )
    ...
    def test_kuhns_viii_dist(self):
        ...
        self.assertAlmostEqual(
            self.cmp.dist('ATCAACGAGT', 'AACGATTAG'), 0.2311305475
        )
        ...
        self.assertAlmostEqual(
            self.cmp_no_d.dist('ATCAACGAGT', 'AACGATTAG'), 0.7210884354
        )

    def test_kuhns_viii_corr(self):
        ...
        self.assertAlmostEqual(
            self.cmp.corr('ATCAACGAGT', 'AACGATTAG'), 0.6533041788
        )
        ...
        self.assertAlmostEqual(
            self.cmp_no_d.corr('ATCAACGAGT', 'AACGATTAG'), -0.0816326531
        )
