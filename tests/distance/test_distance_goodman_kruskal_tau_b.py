...
class GoodmanKruskalTauBTestCases(unittest.TestCase):
    ...
    def test_goodman_kruskal_tau_b_sim(self):
        ...
        self.assertEqual(self.cmp.sim('a', ''), 0.9987261146496815)
        self.assertEqual(self.cmp.sim('', 'a'), float('nan'))
        self.assertEqual(self.cmp.sim('abc', ''), 0.9987261146496815)
        ...
        self.assertAlmostEqual(
            self.cmp.sim('ATCAACGAGT', 'AACGATTAG'), 0.9986935637
        )
    ...
    def test_goodman_kruskal_tau_b_dist(self):
        ...
        self.assertEqual(self.cmp.dist('a', ''), 0.001291793608508618)
        self.assertEqual(self.cmp.dist('', 'a'), float('nan'))
        self.assertEqual(self.cmp.dist('abc', ''), 0.001291793608508618)
        ...
        self.assertAlmostEqual(
            self.cmp.dist('ATCAACGAGT', 'AACGATTAG'), 0.0013248015
        )
