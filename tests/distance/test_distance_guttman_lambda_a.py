...
class GuttmanLambdaATestCases(unittest.TestCase):
    """Test GuttmanLambdaA functions.

    abydos.distance.GuttmanLambdaA
    """

    cmp = GuttmanLambdaA()
    cmp_no_d = GuttmanLambdaA(alphabet=1)

    def test_guttman_lambda_a_sim(self):
    ...
    def test_guttman_lambda_a_dist(self):
