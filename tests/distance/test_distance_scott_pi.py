...
class ScottPiTestCases(unittest.TestCase):
    ...
    def test_scott_pi_sim(self):
        ...
        self.assertEqual(self.cmp.sim('a', ''), 0.4993614303959431)
        self.assertEqual(self.cmp.sim('', 'a'), 0.4993614303959431)
        self.assertEqual(self.cmp.sim('abc', ''), 0.49872122762147786)
        self.assertEqual(self.cmp.sim('', 'abc'), 0.49872122762147786)
        self.assertEqual(self.cmp.sim('abc', 'abc'), 1.0)
        self.assertEqual(self.cmp.sim('abcd', 'efgh'), 0.49679075738125517)
    ...
    def test_scott_pi_dist(self):
        """Test abydos.distance.ScottPi.dist."""
        # Base cases
        self.assertEqual(self.cmp.dist('', ''), 0.0)
        self.assertEqual(self.cmp.dist('a', ''), 0.500638569604057)
        self.assertEqual(self.cmp.dist('', 'a'), 0.500638569604057)
        self.assertEqual(self.cmp.dist('abc', ''), 0.5012787723785221)
        self.assertEqual(self.cmp.dist('', 'abc'), 0.5012787723785221)
        self.assertEqual(self.cmp.dist('abc', 'abc'), 0.0)
        self.assertEqual(self.cmp.dist('abcd', 'efgh'), 0.5032092426187449)
    ...
    def test_scott_pi_corr(self):
        ...
        self.assertAlmostEqual(
            self.cmp.corr('ATCAACGAGT', 'AACGATTAG'), 0.6621417798
        )
