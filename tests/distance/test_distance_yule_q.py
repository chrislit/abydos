...
class YuleQTestCases(unittest.TestCase):
    """Test YuleQ functions.

    abydos.distance.YuleQ
    """

    cmp = YuleQ()
    cmp_no_d = YuleQ(alphabet=1)

    def test_yule_q_sim(self):
        ...
        self.assertAlmostEqual(
            self.cmp.sim('ATCAACGAGT', 'AACGATTAG'), 0.995557201
        )
