...
class KuhnsIIITestCases(unittest.TestCase):
    ...
    def test_kuhns_iii_sim(self):
        ...
        self.assertEqual(self.cmp.sim('', 'abc'), 0.0)
        self.assertEqual(self.cmp.sim('abc', 'abc'), 0.9974424552429668)
        self.assertEqual(self.cmp.sim('abcd', 'efgh'), -0.003198976327575176)

        self.assertAlmostEqual(self.cmp.sim('Nigel', 'Niall'), 0.3294921041)
        self.assertAlmostEqual(self.cmp.sim('Niall', 'Nigel'), 0.3294921041)
        self.assertAlmostEqual(self.cmp.sim('Colin', 'Coiln'), 0.3294921041)
        self.assertAlmostEqual(self.cmp.sim('Coiln', 'Colin'), 0.3294921041)
        self.assertAlmostEqual(
            self.cmp.sim('ATCAACGAGT', 'AACGATTAG'), 0.4932738168
        )
        ...
        self.assertAlmostEqual(
            self.cmp_no_d.sim('ATCAACGAGT', 'AACGATTAG'), -0.097826087
        )
    ...
    def test_kuhns_iii_dist(self):
        ...
        self.assertEqual(self.cmp.dist('', 'abc'), 1.0)
        self.assertEqual(self.cmp.dist('abc', 'abc'), 0.002557544757033181)
        self.assertEqual(self.cmp.dist('abcd', 'efgh'), 1.0031989763275753)

        self.assertAlmostEqual(self.cmp.dist('Nigel', 'Niall'), 0.6705078959)
        self.assertAlmostEqual(self.cmp.dist('Niall', 'Nigel'), 0.6705078959)
        self.assertAlmostEqual(self.cmp.dist('Colin', 'Coiln'), 0.6705078959)
        self.assertAlmostEqual(self.cmp.dist('Coiln', 'Colin'), 0.6705078959)
        self.assertAlmostEqual(
            self.cmp.dist('ATCAACGAGT', 'AACGATTAG'), 0.5067261832
        )
        ...
        self.assertAlmostEqual(
            self.cmp_no_d.dist('ATCAACGAGT', 'AACGATTAG'), 1.097826087
        )
