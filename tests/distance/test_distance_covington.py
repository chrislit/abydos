...
class CovingtonTestCases(unittest.TestCase):
    ...
    def test_covington_dist(self):
        ...
        # Base cases
        self.assertEqual(self.cmp.dist('', ''), -0.25)
        self.assertEqual(self.cmp.dist('a', ''), 1.0)
        self.assertEqual(self.cmp.dist('', 'a'), 1.0)
        self.assertEqual(self.cmp.dist('abc', ''), 1.0)
        self.assertEqual(self.cmp.dist('', 'abc'), 1.0)
        self.assertEqual(self.cmp.dist('abc', 'abc'), 0.019230769230769232)
        self.assertEqual(self.cmp.dist('abcd', 'efgh'), 0.5833333333333334)

        self.assertAlmostEqual(self.cmp.dist('Nigel', 'Niall'), 0.3043478261)
        self.assertAlmostEqual(self.cmp.dist('Niall', 'Nigel'), 0.3043478261)
        self.assertAlmostEqual(self.cmp.dist('Colin', 'Coiln'), 0.2391304348)
        self.assertAlmostEqual(self.cmp.dist('Coiln', 'Colin'), 0.2391304348)
    ...
    def test_covington_sim(self):
        ...
        # Base cases
        self.assertEqual(self.cmp.sim('', ''), 1.25)
        self.assertEqual(self.cmp.sim('a', ''), 0.0)
        self.assertEqual(self.cmp.sim('', 'a'), 0.0)
        self.assertEqual(self.cmp.sim('abc', ''), 0.0)
        self.assertEqual(self.cmp.sim('', 'abc'), 0.0)
        self.assertEqual(self.cmp.sim('abc', 'abc'), 0.9807692307692307)
        self.assertEqual(self.cmp.sim('abcd', 'efgh'), 0.41666666666666663)

        self.assertAlmostEqual(self.cmp.sim('Nigel', 'Niall'), 0.6956521739)
        self.assertAlmostEqual(self.cmp.sim('Niall', 'Nigel'), 0.6956521739)
        self.assertAlmostEqual(self.cmp.sim('Colin', 'Coiln'), 0.7608695652)
        self.assertAlmostEqual(self.cmp.sim('Coiln', 'Colin'), 0.7608695652)
        self.assertAlmostEqual(
    ...
    def test_covington_dist_abs(self):
        ...
        # Base cases
        self.assertEqual(self.cmp.dist_abs('', ''), 10)
