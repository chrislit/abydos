...
class BaroniUrbaniBuserITestCases(unittest.TestCase):
    """Test BaroniUrbaniBuserI functions.

    abydos.distance.BaroniUrbaniBuserI
    """

    cmp = BaroniUrbaniBuserI()
    cmp_no_d = BaroniUrbaniBuserI(alphabet=1)
    ...
    def test_baroni_urbani_buser_i_dist(self):
