...
class UpholtTestCases(unittest.TestCase):
    ...
    def test_upholt_sim(self):
        ...
        self.assertAlmostEqual(
            self.cmp_no_d.sim('Nigel', 'Niall'), 0.7807764064
        )
        self.assertAlmostEqual(
            self.cmp_no_d.sim('Niall', 'Nigel'), 0.7807764064
        )
        self.assertAlmostEqual(
            self.cmp_no_d.sim('Colin', 'Coiln'), 0.7807764064
        )
        self.assertAlmostEqual(
            self.cmp_no_d.sim('Coiln', 'Colin'), 0.7807764064
        )
        self.assertAlmostEqual(
            self.cmp_no_d.sim('ATCAACGAGT', 'AACGATTAG'), 0.8685170918
        )
    ...
    def test_upholt_dist(self):
        ...
        self.assertAlmostEqual(
            self.cmp_no_d.dist('Nigel', 'Niall'), 0.2192235936
        )
        self.assertAlmostEqual(
            self.cmp_no_d.dist('Niall', 'Nigel'), 0.2192235936
        )
        self.assertAlmostEqual(
            self.cmp_no_d.dist('Colin', 'Coiln'), 0.2192235936
        )
        self.assertAlmostEqual(
            self.cmp_no_d.dist('Coiln', 'Colin'), 0.2192235936
        )
        self.assertAlmostEqual(
            self.cmp_no_d.dist('ATCAACGAGT', 'AACGATTAG'), 0.1314829082
        )
