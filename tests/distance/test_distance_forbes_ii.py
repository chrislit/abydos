...
class ForbesIITestCases(unittest.TestCase):
    ...
    def test_forbes_ii_sim(self):
        ...
        self.assertAlmostEqual(self.cmp.sim('Nigel', 'Niall'), 0.4961587708)
        self.assertAlmostEqual(self.cmp.sim('Niall', 'Nigel'), 0.4961587708)
        self.assertAlmostEqual(self.cmp.sim('Colin', 'Coiln'), 0.4961587708)
        self.assertAlmostEqual(self.cmp.sim('Coiln', 'Colin'), 0.4961587708)
        self.assertAlmostEqual(
            self.cmp.sim('ATCAACGAGT', 'AACGATTAG'), 0.6957692308
        )
