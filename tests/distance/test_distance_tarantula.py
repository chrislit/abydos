...
class TarantulaTestCases(unittest.TestCase):
    """Test Tarantula functions.

    abydos.distance.Tarantula
    """

    cmp = Tarantula()
    cmp_no_d = Tarantula(alphabet=1)

    def test_tarantula_sim(self):
        ...
        self.assertAlmostEqual(
            self.cmp_no_d.sim('ATCAACGAGT', 'AACGATTAG'), 0.3888888889
        )

    def test_tarantula_dist(self):
        ...
        self.assertAlmostEqual(
            self.cmp.dist('ATCAACGAGT', 'AACGATTAG'), 0.0060617193
        )
        ...
        self.assertAlmostEqual(
            self.cmp_no_d.dist('ATCAACGAGT', 'AACGATTAG'), 0.6111111111
        )
