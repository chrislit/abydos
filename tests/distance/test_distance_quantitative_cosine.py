...
class QuantitativeCosineTestCases(unittest.TestCase):
    """Test QuantitativeCosine functions.

    abydos.distance.QuantitativeCosine
    """

    cmp = QuantitativeCosine()

    def test_quantitative_cosine_sim(self):
        ...
        self.assertAlmostEqual(
            self.cmp.sim('ATCAACGAGT', 'AACGATTAG'), 0.6674238125
        )

    def test_quantitative_cosine_dist(self):
        ...
        self.assertAlmostEqual(
            self.cmp.dist('ATCAACGAGT', 'AACGATTAG'), 0.3325761875
        )
