...
class MaxwellPillinerTestCases(unittest.TestCase):
    """Test MaxwellPilliner functions.

    abydos.distance.MaxwellPilliner
    """

    cmp = MaxwellPilliner()
    cmp_no_d = MaxwellPilliner(alphabet=1)

    def test_maxwell_pilliner_sim(self):
        ...
        self.assertAlmostEqual(
            self.cmp.sim('ATCAACGAGT', 'AACGATTAG'), 0.6621929447
        )
        ...
        self.assertAlmostEqual(
            self.cmp_no_d.sim('ATCAACGAGT', 'AACGATTAG'), -0.3287671233
        )

    def test_maxwell_pilliner_dist(self):
        ...
        self.assertAlmostEqual(
            self.cmp.dist('ATCAACGAGT', 'AACGATTAG'), 0.3378070553
        )
        ...
        self.assertAlmostEqual(
            self.cmp_no_d.dist('ATCAACGAGT', 'AACGATTAG'), 1.3287671233
        )
