...
class GiniIITestCases(unittest.TestCase):
    ...
    def test_gini_ii_sim(self):
        ...
        self.assertAlmostEqual(
            self.cmp.sim('ATCAACGAGT', 'AACGATTAG'), 0.805819926
        )
        ...
        self.assertAlmostEqual(
            self.cmp_no_d.sim('ATCAACGAGT', 'AACGATTAG'), 0.5419463087
        )
    ...
    def test_gini_ii_dist(self):
        ...
        self.assertAlmostEqual(
            self.cmp.dist('ATCAACGAGT', 'AACGATTAG'), 0.194180074
        )
        ...
        self.assertAlmostEqual(
            self.cmp_no_d.dist('ATCAACGAGT', 'AACGATTAG'), 0.4580536913
        )

    def test_gini_ii_corr(self):
        ...
        self.assertAlmostEqual(
            self.cmp.corr('ATCAACGAGT', 'AACGATTAG'), 0.611639852
        )
        ...
        self.assertAlmostEqual(
            self.cmp_no_d.corr('ATCAACGAGT', 'AACGATTAG'), 0.0838926174
        )
