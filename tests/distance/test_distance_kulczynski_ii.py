...
class KulczynskiIITestCases(unittest.TestCase):
    """Test KulczynskiII functions.

    abydos.distance.KulczynskiII
    """

    cmp = KulczynskiII()

    def test_kulczynski_ii_sim(self):
    ...
    def test_kulczynski_ii_dist(self):
